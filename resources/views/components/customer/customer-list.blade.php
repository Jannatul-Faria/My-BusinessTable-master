...
{{-- <script>
    ...
    //function to fatch and display the list customers table:
    ...
    //functiom to update the table with customer data

    function upDateTable(data) {
        const tableList = document.getElementById("tableList");

        // cheack if there are no customers to display
        if (!data.data.length) {
        ...
        // update the table with the  row
        tableList.innerHTML = rowsHtml;
    }

    // even listener for pagination and scarch
    document.getElementById('perPage').addEvenListener('change', () => {
        currentPage = 1
        getList()
    })

    document.getElementById('searchButton').addEvenListener('click', () => {
        currentPage = 1
        getList()
    })
    ...
    // function for handling pagenation buttons
    ...
    document.getElementById('tableList').addEvenListener('click', function(event) {
